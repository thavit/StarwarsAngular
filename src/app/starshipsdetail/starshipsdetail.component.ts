...
@Component({
  selector: "app-starshipsdetail",
  templateUrl: "./starshipsdetail.component.html",
  styleUrls: ["./starshipsdetail.component.css"]
})
export class StarshipsdetailComponent implements OnInit {
  ...
  ngOnInit() {
    this.apiService
      .getStarship(this.route.snapshot.params["id"])
      .subscribe((data: {}) => {
        console.log(data);
        this.starship = data;
      });
